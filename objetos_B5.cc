...
//*************************************************************************
// dibujar en modo sólido seleccionas un objeto
//*************************************************************************
/*
void _triangulos3D::draw_seleccion_cara(solido *malla, float r, float g, float b)
{
int n_c,n_v,i;
n_c=malla->n_c
glPolygonMode(GL_FRONT_AND_BACK,GL_FILL);
...
for (i=0;i<n_c;i++){
	glColor3ub(r+i,g+i,b);
	n_v=malla->car[i].ind_c[0];
	glVertex3f(malla->ver[n_v].coor[0], malla->ver[n_v].coor[1], malla->ver[n_v].coor[2]);
...
//*************************************************************************
// dibujar en modo sólido una cara cuando la seleccionas
//*************************************************************************
/*
void _triangulos3D::draw_seleccion_cara(solido *malla, float r, float g, float b)
{
